...
The final step in this workflow is to understand the various metabolic pathways represented in each module eigengene. To do this, I will conduct a manual pathway analysis and identify VIP present in each significant cluster.
...
```{r}
write.table(VIP_respirationMetabolites, "metaboanalyst/combined-respiration-VIP.txt", sep = "\t", quote = FALSE, row.names = FALSE)
```
...
```{r}
write.table(VIP_calciumSignalingMetabolites, "metaboanalyst/calcium-signaling-VIP.txt", sep = "\t", quote = FALSE, row.names = FALSE)
```
...
The second step of this workflow is to determine which VIP are present in each WCNA cluster. This will allow me to hone in on biological processes overrepresented in each cluster.
...
Modules 1 and 8 are not significantly correlated with any treatment x day condition, but I will identify VIP in these modules anyways.

```{r}
VIP_module0 <- rbind(t.test_13v30_day3 %>%
                       mutate(., comparison = "13v30_day3") %>%
                       filter(., p.adj < 0.05) %>%
...
```{r}
VIP_module1 <- rbind(t.test_13v30_day3 %>%
                       mutate(., comparison = "13v30_day3") %>%
                       filter(., p.adj < 0.05) %>%
                       filter(., metabolite %in% module1_metabolites$Metabolite),
                     t.test_13v5_day3 %>%
                       mutate(., comparison = "13v5_day3") %>%
                       filter(., p.adj < 0.05) %>%
                       filter(., metabolite %in% module1_metabolites$Metabolite),
                     ...
                     t.test_30_day3v22 %>%
                       ...
                       filter(., p.adj < 0.05) %>%
                       filter(., metabolite %in% module1_metabolites$Metabolite))  %>% 
  mutate(module = "module1") #Identify VIP present in module 0 across all pairwise comparisons
VIP_module1
```
```{r}
VIP_module2 <- rbind(t.test_13v30_day3 %>%
                       mutate(., comparison = "13v30_day3") %>%
                       filter(., p.adj < 0.05) %>%
                     ...
                     t.test_30_day3v22 %>%
                       ...
                       filter(., p.adj < 0.05) %>%
                       filter(., metabolite %in% module2_metabolites$Metabolite))  %>% 
  mutate(module = "module2") #Identify VIP present in module 0 across all pairwise comparisons
VIP_module2
```

```{r}
VIP_module3 <- rbind(t.test_13v30_day3 %>%
                       mutate(., comparison = "13v30_day3") %>%
                       filter(., p.adj < 0.05) %>%
                     ...
                     t.test_30_day3v22 %>%
                       ...
                       filter(., p.adj < 0.05) %>%
                       filter(., metabolite %in% module3_metabolites$Metabolite))  %>% 
  mutate(module = "module3") #Identify VIP present in module 0 across all pairwise comparisons
VIP_module3
```

```{r}
VIP_module4 <- rbind(t.test_13v30_day3 %>%
                       mutate(., comparison = "13v30_day3") %>%
                       filter(., p.adj < 0.05) %>%
                     ...
                     t.test_30_day3v22 %>%
                       ...
                       filter(., p.adj < 0.05) %>%
                       filter(., metabolite %in% module4_metabolites$Metabolite))  %>% 
  mutate(module = "module4") #Identify VIP present in module 0 across all pairwise comparisons
VIP_module4
```
...
VIP_module5 <- rbind(t.test_13v30_day3 %>%
                     ...
                     t.test_30_day3v22 %>%
                       ...
                       filter(., p.adj < 0.05) %>%
                       filter(., metabolite %in% module5_metabolites$Metabolite))  %>% 
  mutate(module = "module5") #Identify VIP present in module 0 across all pairwise comparisons
VIP_module5
```

```{r}
VIP_module6 <- rbind(t.test_13v30_day3 %>%
                       mutate(., comparison = "13v30_day3") %>%
                       filter(., p.adj < 0.05) %>%
...
```
```{r}
VIP_module7 <- rbind(t.test_13v30_day3 %>%
                       mutate(., comparison = "13v30_day3") %>%
                       filter(., p.adj < 0.05) %>%
...
```
```{r}
VIP_module8 <- rbind(t.test_13v30_day3 %>%
                       mutate(., comparison = "13v30_day3") %>%
                       filter(., p.adj < 0.05) %>%
                       filter(., metabolite %in% module8_metabolites$Metabolite),
                     t.test_13v5_day3 %>%
                       mutate(., comparison = "13v5_day3") %>%
                       filter(., p.adj < 0.05) %>%
                       filter(., metabolite %in% module8_metabolites$Metabolite),
                     ...
                     t.test_30_day3v22 %>%
                       ...
                       filter(., p.adj < 0.05) %>%
                       filter(., metabolite %in% module8_metabolites$Metabolite))  %>% 
  mutate(module = "module8") #Identify VIP present in module 0 across all pairwise comparisons
VIP_module8
```
...
VIP_allModules <- rbind(VIP_module0,
                        ...
                        VIP_module6,
                        VIP_module7,
                        VIP_module8) #Combine all VIP lists
```
...
```{r}
heatmapColors <- brewer.pal("RdPu", n = 9)
```
