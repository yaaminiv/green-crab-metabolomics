...
Certain compounds were not recognized by MetaboAnalyst, or require manual PubChem/KEGG ID correction. The resulting name maps (input names v.s names used for enrichment analysis) from MetaboAnalyst were renamed according to module number and saved [here]().

The output tables (msea_ora_result.csv files from MetaboAnalyst) were renamed according to module number and saved [here]().  
