...
The last thing I want to do with the list of all VIP is to add PubChem and KEGG annotations. This will allow me to upload the list into MetaboAnalyst and check for significantly enriched pathways or compound classes.
