...
The last thing I want to do with the list of all VIP is to add PubChem and KEGG annotations. This will allow me to upload the list into MetaboAnalyst to conduct pathway assignment and check for enriched pathways.
...
- Took pathway analysis output into the Enrichment Analysis module
- Conducted enrichment test with pathways
- Downloaded MetaboAnalyst output
