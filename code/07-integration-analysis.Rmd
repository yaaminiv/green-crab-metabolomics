...
circosPlot(diablo.ML.VIP, cutoff = 0.70, line = TRUE, 
           color.blocks = c('plum1', 'lightgreen'),
           color.cor = c("chocolate3","grey20"), 
           size.labels = 1,
           legend.title = "Temperature (ºC)", color.Y = rev(plotColors)) #Use circos plot to visualise correlations between individual metabolites and lipids
...
diablo.ML.VIP.group2 <- c("hydroquinone", "PE 40:7|PE 18:1_22:6", "PC 33:2 Isomer A", "PE 40:6IPE 18:1_22:5") #hydroquinone and correlated lipids
...
do separately for each compound type
