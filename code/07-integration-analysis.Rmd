...
```{r}
#Save dataframes
write.csv(metabLipidCorClean, "metabolite-lipid-module-correlations.csv", quote = FALSE, row.names = FALSE)
write.csv(metabLipidPvalueClean, "metabolite-lipid-module-pvalues.csv", quote = FALSE, row.names = FALSE)
```
...
High level: metabolites pos and neg associated with lipids
