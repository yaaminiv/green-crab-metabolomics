...
- is it a VIP from the temperature comparisons?
- is it in a significantly enriched pathway from the temperature comparisons?

```{r}
read.delim("../05-metabolomics-analysis/metaboanalyst/all-module-VIP.txt", sep = "\t") %>%
