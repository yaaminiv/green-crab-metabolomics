...
significantVIP_13v30_annot %>%
  ...
  arrange(., lipid)
  pivot_wider(., id_cols = c(lipid, module, class, targetClass, saturation, `13v30`, `13v5`), names_from = "comparison", values_from = c(statistic, p.adj))
#Combine lists of VIP. Remove any leading or trailing white space from lipids and select columns of interest. Arrange by lipid name. Modify information in comparison column. Retain only unique rows. Pivot wider and change comparison information to be Y or N.
```
...
- import annotations for each class of VIP
- add to VIP in specific modules
