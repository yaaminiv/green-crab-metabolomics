...
The next thing I want to do is export a list of lipids to use with the web-based GUI [LIpid ONtology (LION)](). I am using this instead of MetaboAnalyst because it is specific for lipids, wherease MetaboAnalyst doesn't recognize most lipids in this dataset.
