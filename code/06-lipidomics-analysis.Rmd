...
plotIndiv(myResult.splsda.final_T, comp = c(1,2), ind.names = FALSE,
          ...
          ellipse = TRUE, star = TRUE, centroid = FALSE, 
          legend = TRUE, legend.title = "Temperature (ºC) x Day", 
          title = "sPLS-DA by Temperature and Day", X.label = "Component 1: 15% Explained Variance", size.xlabel = 15, Y.label = "Component 2: 9% Explained Variance", size.ylabel = 15, size.axis = 13,
          style = "ggplot2")
#dev.off()
```
