...
dat_wl <- all_crab %>%
  ...
  mutate(width_length = carapace.width/carapace.length) %>%
...
ordi.monte(dat_wl, ord = "pca", dim = 6, plot = FALSE) #Conduct monte carlo randomization test using 1000 random permutations of the input data. PC1, PC2, PC3 p-values < 0.05
