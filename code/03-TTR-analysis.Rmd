...
To understand how "important" the random effect is, I am going to fit a model without the random effect and compare the models using LRT and AIC comparisons.
...
head(tempDay_EMM) #Confirm formatting 
```
...
Instead of plotting raw averages, I am going to plot averages and standard error output from `emmeans`, since that output takes into account variance explained by the random effect.
