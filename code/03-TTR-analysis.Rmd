...
There was a significant impacts of treatment, day, their interaction, and sex! I will investigate these effects using post-hoc tests with `emmeans`.
...
```{r}
TTRmodel_sex <- emmeans(TTRmodelGamma4, pairwise ~ sex, adjust = "tukey", data = modTTR) #Use emmeans to obtain pairwise treatment differences
TTRmodel_sex$contrasts %>% broom::tidy(.) #Extract the contrast information to look at pairwise test output. Clean output using broom.
TTRmodel_sex$contrasts %>% 
  broom::tidy(.) %>%
