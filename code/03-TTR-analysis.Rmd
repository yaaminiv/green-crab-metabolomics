...
TTRmodel3 <- glmer( #Generalized linear mixed effect model
  TTRavg ~ as.factor(treatment)*day.sc + #Treatment, day, and their interaction
...
```{r}
TTRmodel4 <- glmer( #Generalized linear mixed effect model
  TTRavg ~ as.factor(treatment)*day.sc + #Treatment, day, and their interaction
...
```{r}
sim_residuals <- simulateResiduals(fittedModel = TTRmodel4, plot = TRUE) #Simulate residuals for the final model
```
