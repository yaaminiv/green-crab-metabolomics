...
The 13ºC and 30ºC treatments have more variability than the 5ºC treatments. To quantify this, I will calculate the coefficient of variation for each treatment x day combination.

```{r}
head(all_MO2_slope_results)
```
