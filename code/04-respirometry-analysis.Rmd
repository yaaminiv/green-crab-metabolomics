...
all_MO2_slope_results_reorder %>%
  ...
  annotate(geom = "text", x = 1, y = 30000, 
           label = expression(paste(bolditalic("13ºC vs. 30ºC: "), "t = -2.38, p = 0.05")),
           hjust = 0) +
  annotate(geom = "text", x = 1, y = 29000, 
           label = expression(paste(bolditalic("13ºC vs. 5ºC: "), "t = 8.09, p < 0.0001")),
           hjust = 0) +
  annotate(geom = "text", x = 1, y = 28000, 
           label = expression(paste(bolditalic("Day: "), "t = 3.75, p < 0.0001")),
           hjust = 0) +
  theme_classic(base_size = 15)
