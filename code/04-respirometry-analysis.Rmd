...
dat20220712_MO2_slope_results <- dat20220712_MO2_slopes %>%
  ...
  mutate(slope_nmol_hr = estimate*1000*60) %>%
  dplyr::select(treatment, probe_num, slope_nmol_hr, p.value) %>%
  mutate(r.squared = (dat20220712_MO2_glance$r.squared)) #Get the regression information for dt_s and not the intercept. Creates new a variable for respiration rate as nmol_per_hour (slope_nmol_hr). Select treatment, probe number, slope over the hour, and p-value. Add the r-squared information from glance.
...
dat20220719_MO2_slope_results <- dat20220719_MO2_slopes %>%
  ...
  mutate(slope_nmol_hr = estimate*1000*60) %>%
  dplyr::select(treatment, probe_num, slope_nmol_hr, p.value) %>%
  mutate(r.squared = (dat20220719_MO2_glance$r.squared)) #Get the regression information for dt_s and not the intercept. Creates new a variable for respiration rate as nmol_per_hour (slope_nmol_hr). Select treatment, probe number, slope over the hour, and p-value. Add the r-squared information from glance.
...
dat20220726_MO2_slope_results <- dat20220726_MO2_slopes %>%
  ...
  mutate(slope_nmol_hr = estimate*1000*60) %>%
  dplyr::select(treatment, probe_num, slope_nmol_hr, p.value) %>%
  mutate(r.squared = (dat20220726_MO2_glance$r.squared)) #Get the regression information for dt_s and not the intercept. Creates new a variable for respiration rate as nmol_per_hour (slope_nmol_hr). Select treatment, probe number, slope over the hour, and p-value. Add the r-squared information from glance.
...
dat20220708_MO2_slopes_blanks_results <- dat20220708_MO2_slopes_blanks %>%
  ...
  mutate(slope_nmol_hr = estimate*1000*60) %>%
  dplyr::select(treatment, probe_num, slope_nmol_hr, p.value) %>%
  mutate(r.squared = (dat20220708_MO2_glance_blanks$r.squared)) #Get the regression information for dt_s and not the intercept. Creates new a variable for respiration rate as nmol_per_hour (slope_nmol_hr). Select treatment, probe number, slope over the hour, and p-value. Add the r-squared information from glance.
...
dat20220708_MO2_slope_results <- dat20220708_MO2_slope_results %>%
  mutate(., slope_nmol_hr_blank = dat20220708_MO2_slopes_blanks_results$slope_nmol_hr) %>%
  mutate(., slope_nmol_hr_corrected = slope_nmol_hr - dat20220708_MO2_slopes_blanks_results$slope_nmol_hr) %>%
  mutate(., blank_ratio = abs(slope_nmol_hr_blank / slope_nmol_hr)) #Create a new column for the blank slope, the corrected slope (uncorrected slope - blank slope), and the blank ratio (blank / uncorrected slope)
dat20220708_MO2_slope_results
```
...
dat20220712_MO2_slopes_blanks_results <- dat20220712_MO2_slopes_blanks %>%
  ...
  mutate(slope_nmol_hr = estimate*1000*60) %>%
  dplyr::select(treatment, probe_num, slope_nmol_hr, p.value) %>%
  mutate(r.squared = (dat20220712_MO2_glance_blanks$r.squared)) #Get the regression information for dt_s and not the intercept. Creates new a variable for respiration rate as nmol_per_hour (slope_nmol_hr). Select treatment, probe number, slope over the hour, and p-value. Add the r-squared information from glance.
...
dat20220712_MO2_slope_results <- dat20220712_MO2_slope_results %>%
  mutate(., slope_nmol_hr_blank = dat20220712_MO2_slopes_blanks_results$slope_nmol_hr) %>%
...
dat20220719_MO2_slope_results <- dat20220719_MO2_slope_results %>%
  mutate(., slope_nmol_hr_blank = dat20220719_MO2_slopes_blanks_results$slope_nmol_hr) %>%
...
dat20220726mod %>%
  ...
  mutate(., dt_s = ifelse(tank == "Tank_5", dt_s - 3344, dt_s)) %>%
...
dat20220726_MO2_slopes_blanks_results <- dat20220726_MO2_slopes_blanks %>%
  ...
  mutate(slope_nmol_hr = estimate*1000*60) %>%
  dplyr::select(treatment, probe_num, slope_nmol_hr, p.value) %>%
  mutate(r.squared = (dat20220726_MO2_glance_blanks$r.squared)) #Get the regression information for dt_s and not the intercept. Creates new a variable for respiration rate as nmol_per_hour (slope_nmol_hr). Select treatment, probe number, slope over the hour, and p-value. Add the r-squared information from glance.
...
dat20220726_MO2_slope_results <- dat20220726_MO2_slope_results %>%
  mutate(., slope_nmol_hr_blank = dat20220726_MO2_slopes_blanks_results$slope_nmol_hr) %>%
...
```{r}
dat20220708_corr_fig <- dat20220708_MO2_slope_results_reorder %>%
  ggplot(., aes(x = treatment, y = -slope_nmol_hr_corrected, color = treatment)) + 
  geom_boxplot() + geom_point(size = 2) +
  xlab("") + ylab("") +
  labs(title = "Day 4") +
...
```{r}
dat20220712_corr_fig <- dat20220712_MO2_slope_results_reorder %>%
  ggplot(., aes(x = treatment, y = -slope_nmol_hr_corrected, color = treatment)) + 
  geom_boxplot() + geom_point(size = 2) +
  xlab("") + ylab("") +
  labs(title = "Day 8") +
...
```{r}
dat20220719_corr_fig <- dat20220719_MO2_slope_results_reorder %>%
  ggplot(., aes(x = treatment, y = -slope_nmol_hr_corrected, color = treatment)) + 
  geom_boxplot() + geom_point(size = 2) +
  xlab("") + ylab("") +
  labs(title = "Day 15") +
...
```{r}
dat20220726_corr_fig <- dat20220726_MO2_slope_results_reorder %>%
  ggplot(., aes(x = treatment, y = -slope_nmol_hr_corrected, color = treatment)) + 
  geom_boxplot() + geom_point(size = 2) +
  xlab("") + ylab("") +
  labs(title = "Day 22") +
  ...
  scale_color_manual(values = c(plotColors[3], plotColors[2], plotColors[1]), 
                     guide = "none") +
  theme_classic(base_size = 15) + theme(plot.margin = margin(0, 0, 0, 3, "pt")) #Create a boxplot for oxygen consumption (µmol/hr). Use -slope_nmol_hr so the larger the slope, the faster the oxygen consumption over the hour. Add a line connecting each boxplot midpoint.
dat20220726_corr_fig
```

```{r}
#pdf("figures/multipanel-oxygen-consumption-corrected.pdf", height = 8.5, width = 11)

dat20220708_corr_fig | dat20220712_corr_fig | dat20220719_corr_fig | dat20220726_corr_fig
grid::grid.draw(grid::textGrob("Oxygen Consumption (nmol/hr)", x = 0.03, rot = 90, gp = gpar(fontsize = 17)))
grid::grid.draw(grid::textGrob("Temperature (ºC)", y = 0.04, gp = gpar(fontsize = 17)))
...
```{r}
lm20220708 <- lm(slope_nmol_hr ~ treatment, data = dat20220708_MO2_slope_results)
summary(lm20220708)
```

```{r}
lm20220712 <- lm(slope_nmol_hr ~ treatment, data = dat20220712_MO2_slope_results)
summary(lm20220712)
```

```{r}
lm20220719 <- lm(slope_nmol_hr ~ treatment, data = dat20220719_MO2_slope_results)
summary(lm20220719)
```

```{r}
lm20220726 <- lm(slope_nmol_hr ~ treatment, data = dat20220726_MO2_slope_results)
summary(lm20220726)
```
...
```{r}
all_MO2_slope_results <- bind_rows("4" = dat20220708_MO2_slope_results,
          "8" = dat20220712_MO2_slope_results,
...
```{r}
lmAllSlopeResults <- lm(slope_nmol_hr ~ treatment*as.numeric(day), data = all_MO2_slope_results)
