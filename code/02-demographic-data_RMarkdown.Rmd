...
cw1_bp <- ggplot(data = cw_1, aes(x=date, y=carapace.width)) + geom_boxplot() + geom_jitter() + stat_compare_means() + labs(y = "Carapace Width", x = "Day") 
cw2_bp <- ggplot(data = cw_2, aes(x=date, y=carapace.width)) + geom_boxplot() + geom_jitter() + stat_compare_means() + labs(y = "Carapace Width", x = "Day") 
cw3_bp <- ggplot(data = cw_3, aes(x=date, y=carapace.width)) + geom_boxplot() + geom_jitter() + stat_compare_means() + labs(y = "Carapace Width", x = "Day") 
cw4_bp <- ggplot(data = cw_4, aes(x=date, y=carapace.width)) + geom_boxplot() + geom_jitter() + stat_compare_means() + labs(y = "Carapace Width", x = "Day") 
cw5_bp <- ggplot(data = cw_5, aes(x=date, y=carapace.width)) + geom_boxplot() + geom_jitter() + stat_compare_means() + labs(y = "Carapace Width", x = "Day") 
cw6_bp <- ggplot(data = cw_6, aes(x=date, y=carapace.width)) + geom_boxplot() + geom_jitter() + stat_compare_means() + labs(y = "Carapace Width", x = "Day") 
...
cl1_bp <- ggplot(data = cl_1, aes(x=date, y=carapace.length)) + geom_boxplot() + geom_jitter() + stat_compare_means() + labs(y = "Carapace Length", x = "Day") 
cl2_bp <- ggplot(data = cl_2, aes(x=date, y=carapace.length)) + geom_boxplot() + geom_jitter() + stat_compare_means() + labs(y = "Carapace Length", x = "Day") 
cl3_bp <- ggplot(data = cl_3, aes(x=date, y=carapace.length)) + geom_boxplot() + geom_jitter() + stat_compare_means() + labs(y = "Carapace Length", x = "Day") 
cl4_bp <- ggplot(data = cl_4, aes(x=date, y=carapace.length)) + geom_boxplot() + geom_jitter() + stat_compare_means() + labs(y = "Carapace Length", x = "Day") 
cl5_bp <- ggplot(data = cl_5, aes(x=date, y=carapace.length)) + geom_boxplot() + geom_jitter() + stat_compare_means() + labs(y = "Carapace Length", x = "Day") 
cl6_bp <- ggplot(data = cl_6, aes(x=date, y=carapace.length)) + geom_boxplot() + geom_jitter() + stat_compare_means() + labs(y = "Carapace Length", x = "Day") 
...
w1_bp <- ggplot(data = w_1, aes(x=date, y=weight)) + geom_boxplot() + geom_jitter() + stat_compare_means() + labs(y = "Weight", x = "Day") 
w2_bp <- ggplot(data = w_2, aes(x=date, y=weight)) + geom_boxplot() + geom_jitter() + stat_compare_means() + labs(y = "Weight", x = "Day") 
w3_bp <- ggplot(data = w_3, aes(x=date, y=weight)) + geom_boxplot() + geom_jitter() + stat_compare_means() + labs(y = "Weight", x = "Day") 
w4_bp <- ggplot(data = w_4, aes(x=date, y=weight)) + geom_boxplot() + geom_jitter() + stat_compare_means() + labs(y = "Weight", x = "Day") 
w5_bp <- ggplot(data = w_5, aes(x=date, y=weight)) + geom_boxplot() + geom_jitter() + stat_compare_means() + labs(y = "Weight", x = "Day") 
w6_bp <- ggplot(data = w_6, aes(x=date, y=weight)) + geom_boxplot() + geom_jitter() + stat_compare_means() + labs(y = "Weight", x = "Day") 
